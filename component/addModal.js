...
class AddModal extends React.Component {
    ...
    async DatHang(){
        const url = 'http://react-native-btl.000webhostapp.com/na/dathang.php?name=' + this.state.name + '&sdt=' + this.state.phoneNumber + '&diaChi=' + this.state.address + '&soluong=' + this.state.sl+'&idHang='+this.props.item.id;
        ...
        return (
            ...
            >
                ...
                <View style={{ height: 40,flexDirection: 'row',marginBottom:20 }}>
                    ...
                    <TouchableOpacity onPress={() => { this.DatHang() }} style={{ borderRadius: 4, backgroundColor: 'yellow', flex: 1 }}>
